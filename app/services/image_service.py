...
class ImagesService():
    ...
    async def post_image(self, image: ItemPostDTO, background_tasks: BackgroundTasks) -> tuple[str, int]:
        ...
        background_tasks.add_task(self.image_utils.save_to_disk, content_dir, img_hash, img, thumbnail, mode=quality)
